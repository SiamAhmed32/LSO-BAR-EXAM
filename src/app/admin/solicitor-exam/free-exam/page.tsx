...
const SolicitorFreeExam = () => {
	...
	const [questions, setQuestions] = useState<Question[]>([
		{
			id: '1',
			question: 'What is the primary role of a solicitor?',
			options: [
				{ id: '1-1', text: 'To represent clients in court', isCorrect: false },
				{ id: '1-2', text: 'To provide legal advice and services', isCorrect: true },
				{ id: '1-3', text: 'To judge cases', isCorrect: false },
				{ id: '1-4', text: 'To enforce laws', isCorrect: false },
			],
		},
	]);
