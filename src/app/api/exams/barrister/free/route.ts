...
// GET all questions for barrister free exam (public access)
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    console.error("Barrister Free Exam GET Error:", error);
...
// POST create a new question for barrister free exam
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    console.error("Barrister Free Exam POST Error:", error);
    return NextResponse.json(
      {
        error: "Internal Server Error",
...
export async function PUT(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    console.error("Barrister Free Exam PUT Error:", error);
    return NextResponse.json(
      {
        error: "Internal Server Error",
