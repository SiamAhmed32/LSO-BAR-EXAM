...
export async function GET(
  ...
  try {
    ...
    console.error("Solicitor Free Exam Question GET Error:", error);
    return NextResponse.json(
      {
...
export async function PUT(
  ...
  try {
    ...
    console.error("Solicitor Free Exam Question PUT Error:", error);
    return NextResponse.json(
      {
        error: "Internal Server Error",
...
export async function DELETE(
  ...
  try {
    ...
    console.error("Solicitor Free Exam Question DELETE Error:", error);
    return NextResponse.json(
      {
        error: "Internal Server Error",
