	...
	return (
		<div className="flex flex-col">
			...
			<div className="flex items-center gap-1 w-full whitespace-nowrap">
				{/* LSO in Pink */}
				<span className="text-2xl md:text-3xl lg:text-[25px] xl:text-[30px] font-bold text-logoPink">LSO</span>
				...
				{/* BAR EXAM in Black */}
				<span className="text-2xl md:text-3xl lg:text-[24px] xl:text-[29px] font-bold text-black ml-2">BAR EXAM</span>
			</div>
			{/* Subtitle */}
			<div className="w-full text-[10.5px] md:text-[12.8px] lg:text-[10.5px] xl:text-[12.5px] whitespace-nowrap  text-black mt-0.5">
