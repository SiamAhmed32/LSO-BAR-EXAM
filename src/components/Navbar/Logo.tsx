	...
	return (
		<div className="flex flex-col">
			...
			<div className="flex items-center gap-1 w-full ">
				{/* LSO in Pink */}
				<span className="text-2xl md:text-3xl font-bold text-logoPink">LSO</span>
				...
				{/* BAR EXAM in Black */}
				<span className="text-2xl md:text-3xl font-bold text-black ml-2">BAR EXAM</span>
			</div>
			{/* Subtitle */}
			<div className="w-full text-[10.5px] md:text-[12.8px] whitespace-nowrap  text-black mt-0.5">
